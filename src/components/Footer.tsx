        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-dlp-cyan transition-colors">About Us</a></li>
              <li><a href="#" className="text-gray-400 hover:text-dlp-cyan transition-colors">Case Studies</a></li>
              <li><a href="#" className="text-gray-400 hover:text-dlp-cyan transition-colors">Pricing</a></li>
              <li><a href="#" className="text-gray-400 hover:text-dlp-cyan transition-colors">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-dlp-cyan transition-colors">
